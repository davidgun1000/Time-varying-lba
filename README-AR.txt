### Instructions for estimating the AR model to the Forstmann et al. (2008) data ###
...
* LBA_PMwG_Markov_v1.m : This is the primary file to run the method. Start here. This file loads the data as required:
...
* LBA_CSMC_prior_prop.m
* LBA_CSMC_prior_rw.m
* refreshed_backward_simulation_prior_prop.m
* refreshed_backward_simulation_prior_rw.m
* reshape_b.m
* reshape_v.m
